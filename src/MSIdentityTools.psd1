...
@{
    ...
    NestedModules        = @(
        ...
        '.\Import-MsIdAdfsJsonRelyingParty.ps1'
        '.\Import-MsIdAdfsJsonAccessPolicy.ps1'
        '.\Add-MsIdAdfsRelyingPartySamlResponseUri.ps1'
    ...
    FunctionsToExport    = @(
        ...
        'Import-MsIdAdfsJsonRelyingParty'
        'Import-MsIdAdfsJsonAccessPolicy'
        'Add-MsIdAdfsRelyingPartySamlResponseUri'
